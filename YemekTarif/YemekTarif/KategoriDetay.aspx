<%@ Page Title="" Language="C#" MasterPageFile="~/sablon.Master" AutoEventWireup="true" CodeBehind="KategoriDetay.aspx.cs" Inherits="YemekTarif.KategoriDetay" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <ItemTemplate>
        <table class="auto-style9">
            <tr>
                <td class="auto-style2" style="background-color:cornflowerblue;"><a href="YemekDetay.aspx?Yemekid=<%# Eval("Yemekid") %>"><strong>
